...
export default function CheckoutPage({
  ...
  const onApprove = async (data: any) => {
    try {
      ...
      window.location.href = `/postcheckout?success=true&orderID=${data.orderID}`;
    } catch (error) {
  ...
  // Debug: Log the PayPal client ID
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            ...
            <div className="border border-mainBlack rounded-lg p-4 mb-4 flex items-center">
              ...
              />
              <label htmlFor="paypal" className="flex-grow font-medium">
                Pay with PayPal
              </label>
            ...
            <div className="border border-gray-300 rounded-lg p-4 mb-4 flex items-center opacity-50">
              <input
                type="radio"
                id="creditCard"
                name="paymentMethod"
                ...
                disabled
              />
              <label htmlFor="creditCard" className="flex-grow font-medium text-gray-500">
