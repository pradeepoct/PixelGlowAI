...
export default function Terms() {
  ...
  useEffect(() => {
    ...
    document.title = "Terms and Conditions | PIXELGLOWAI.app";
  }, []);
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <main className="bg-[#f6f5ec] p-8 border-2 border-[#091E25]">
          ...
          <p className="mb-4">
            ...
            <br />
            By using PIXELGLOWAI.app, you confirm your acceptance of, and agree to
          ...
          <p className="mb-4">
            ...
            PIXELGLOWAI.app website or our AI headshot generation service.
          </p>
          <p className="mb-4">
            <strong>3. Service Access</strong>
            <br />
            PIXELGLOWAI.app offers various plans for AI-generated headshots. Our
          ...
          <p className="mb-4">
            ...
            PIXELGLOWAI.app will meet all your requirements or that its operation
          ...
          <p className="mb-4">
            ...
            <br />
            PIXELGLOWAI.app provides its AI headshot generation service &quot;as
          ...
          <p className="mb-4">
            ...
            AI-generated headshots. PIXELGLOWAI.app is not responsible for any
          ...
          <p className="mb-4">
            ...
            <br />
            This Agreement is governed by the laws of United States. You acknowledge
