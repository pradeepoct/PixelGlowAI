      ...
      <div className="max-w-3xl mx-auto">
        ...
        <main className="bg-[#f6f5ec] p-8 border-2 border-[#091E25]">
          ...
          <p className="mb-4">
            ...
            <br />
            At PIXELGLOWAI, we stand behind the quality of our AI-generated
          ...
          <p className="mb-4">
            ...
            <br />
            PIXELGLOWAI reserves the right to cancel a refund if we find evidence
