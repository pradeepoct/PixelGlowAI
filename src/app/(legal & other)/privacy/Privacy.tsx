...
export default function Privacy() {
  ...
  useEffect(() => {
    ...
    document.title = "Privacy Policy | PIXELGLOWAI.app";
  }, []);
    ...
    <div className="min-h-screen bg-[#f6f5ec] text-[#091E25] p-4">
      <div className="max-w-3xl mx-auto">
        ...
        <main className="bg-[#f6f5ec] p-8 border-2 border-[#091E25]">
          ...
          <p className="mb-4">
            Your privacy is important to us. It is PIXELGLOWAI&apos;s policy to
            respect your privacy regarding any information we may collect from
            you across our website, PIXELGLOWAI.app, and other sites we own and
            operate.
          </p>
          <p className="mb-4">
          ...
          <p className="mb-4">
            ...
            with regard to the personal data processed through PIXELGLOWAI.app and
          ...
          <p className="mb-4">
            Visiting Address: Sveavägen 38, 111 34 Stockholm, United States.
          </p>
