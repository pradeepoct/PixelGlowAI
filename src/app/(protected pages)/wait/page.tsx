  ...
  if (userData && userData.length > 0) {
    ...
    if (
      ...
      await sendEmail({
        ...
        from: process.env.NOREPLY_EMAIL || "noreply@pixelglowai.app", // Using env variable with fallback
        templateId: "payment_success", // Processing started notification
        data: {
          planName: "Professional", // You might want to get this from user data
          amount: "$39",
          headshots: "100",
          turnaround: "2 hours"
        }
      ...
      // Note: Resend doesn't support scheduled sending like SendGrid
      // You would need to implement a queue system or use a cron job for this
      // For now, we'll comment this out and implement it differently
      /*
      ...
      await sendEmail({
        ...
        templateId: "headshots_ready", // Updated template ID for completion email
        data: {
          headshots: "100"
        }
      });
        ...
        <div className="max-w-md">
          ...
          <ul className="space-y-2 text-sm text-gray-600">
            ...
            <li className="flex items-center">
              ...
              Founded in United States. We respect your high standards.
            </li>
          </ul>
